...
class SurveyController extends Controller
{
  ...
  /** 
    ...
    public function template1(Request $request){
        ...
        //     $temp1 = new template1;
        //     // $temp1->name = $data['project_name'];
        //     // $project->parent_id = $data['parent_id'];
        //     $temp1->save();
        //     return redirect('survey/create-survey')->with('flash_message_success','Projects Created Successfully!');

        // }
        return view('/survey/survey_template1');
    }

    public function template2(Request $request){
        return view('/survey/survey_template2');
    }

    public function template3(Request $request){
        return view('/survey/survey_template3');
    }
